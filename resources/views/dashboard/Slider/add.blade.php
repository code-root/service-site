...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">إضافة شريحة جديدة</span>
        </h4>
            ...
            <div class="col-12 col-lg-8">
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Info الشريحة</h5>
                    </div>
                    ...
                    <form id="add-item-form" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label" for="status">button url</label>
                                    <input type="txt" id="button_url" name="button_url" class="form-control" >
        ...
        $('#add-item-form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    window.location.href = "{{ route('appSlider.index') }}"; // إعادة التوجيه إلى صفحة السلايدر
                },
                error: function(xhr) {
                    // عرض رسائل الخطأ
