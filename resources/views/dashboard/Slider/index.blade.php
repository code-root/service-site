                    ...
                    <div class="card-header flex-column flex-md-row">
                        ...
                        <div class="dt-action-buttons text-end pt-3 pt-md-0">
                            <div class="dt-buttons">
                                <a href="{{ route('appSlider.add')}}" class="send-model dt-button create-new btn btn-primary waves-effect waves-light" >
...
<div class="modal fade" id="editSliderModal" tabindex="-1" aria-labelledby="editSliderModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editSliderModalLabel">edit السلايدر</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="editSliderForm">
                    ...
                    <button type="submit" class="btn btn-primary">حفظ الeditات</button>
                </form>
            </div>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    // إرسال النموذج لUpdate البيانات
