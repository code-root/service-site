            ...
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <div class="eman-footer-widget">
                        <div class="logo">
                            <a href="index-2.html">
                                <img class="logo-light" src="{{ asset('public/storage/' . ($basicFields['logo'] ?? 'default-logo.png')) }}" alt="Corporate Logo">
                            </a>
                        </div>
                        <p class="description">{{ $settings['footer_description'] ?? 'Default footer description' }}</p>
                        <div class="widget-information">
                            <ul class="information-list">
                                <li><span>Call:</span><a href="tel:{{ $basicFields['phone'] ?? '+01 123 5641 231' }}">{{ $basicFields['phone'] ?? '+01 123 5641 231' }}</a></li>
                                <li><span>Email:</span><a href="mailto:{{ $basicFields['email'] ?? 'info@al-eman-.com' }}" target="_blank">{{ $basicFields['email'] ?? 'info@al-eman-.com' }}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="eman-footer-widget">
                        ...
                        <div class="inner">
                            ...
                            <ul class="social-share icon-transparent">
                                ...
                                <li><a href="{{ $settings['tiktok'] }}" class="color-tiktok"><img alt="svgImg" style="background-color: aliceblue;width: 31px" src="data:image/svg+xml;base64," style="width: 31px;background-color: aliceblue;"></a></li>
                                @endif
                                @if(!empty($settings['x']))
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner text-center">
                        <p>Copyright <script>document.write(new Date().getFullYear())</script> Developed By <a href="{{ config('developer.link') }}" target="_blank">{{ config('developer.name') }}</a>. All Rights Reserved</p>
                    </div>
                </div>
            </div>
        </div>
